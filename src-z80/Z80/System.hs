...
type Z80emulation      = EmulatedProcessor Z80state Z80instruction Z80addr Z80byte
...
-- TRS-80 Model I.
type Z80system sysType = EmulatedSystem Z80state Z80instruction Z80addr Z80byte

-- | Z80 memory system type
type Z80memory         = MemorySystem Z80addr Z80byte
