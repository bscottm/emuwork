...
mkMsysTests =
  [ testGroup "Regular instructions"
    ...
    , testCase "LD (NN),HL          " (z80instTest (TI [0x22, 0x9a, 0xbc            ] (LD (HLIndirectStore (AbsAddr 0xbc9a)))))
    ...
    , testCase "LD HL,(NN)          " (z80instTest (TI [0x2A, 0x0f, 0x12            ] (LD (HLIndirectLoad (AbsAddr 0x120f)))))
  ...
  , testGroup "0xdd prefix (IX-indexed instructions)"
    ...
    , testCase "LD (NN),IX          " (z80instTest (TI [0xdd, 0x22, 0x9a, 0xbc      ] (LD (IXIndirectStore (AbsAddr 0xbc9a)))))
    ...
    , testCase "LD IX,(NN)          " (z80instTest (TI [0xDD, 0x2A, 0xde, 0x0f      ] (LD (IXIndirectLoad (AbsAddr 0x0fde)))))
  ...
  , testGroup "0xfd prefix (IY-indexed instructions)"
    ...
    , testCase "LD (NN),IY          " (z80instTest (TI [0xfd, 0x22, 0x9a, 0xbc      ] (LD (IYIndirectStore (AbsAddr 0xbc9a)))))
    ...
    , testCase "LD IY,(NN)          " (z80instTest (TI [0xFD, 0x2A, 0xde, 0x0f      ] (LD (IYIndirectLoad (AbsAddr 0x0fde)))))
